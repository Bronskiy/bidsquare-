...
{!! Form::model($homepage, array('files' => true, 'class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array(config('quickadmin.route').'.homepage.update', $homepage->id))) !!}
...
<div class="form-group">
  ...
  @if($homepage->slider_background != '')<div class="col-sm-10 col-sm-offset-2"><img src="{{ asset('uploads/thumb') . '/'.  $homepage->slider_background }}"></div>@endif
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('google_search', old('google_search',$homepage->google_search), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('bing_search', old('bing_search',$homepage->bing_search), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('terms_text', old('terms_text',$homepage->terms_text), array('class'=>'form-control ckeditor')) !!}
