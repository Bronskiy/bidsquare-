<div class="top-bar">
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div class="social-box">
      ...
      <a href="/404"><i class="fa fa-search"></i></a>
    </div>
    @endforeach
  </div>
</div>
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-right justify-content-end" id="navbarNav">
      <ul class="navbar-nav">
        @if ( ! $HomeMenuData->isEmpty() )
        @foreach ($HomeMenuData->sortBy('menu_order') as $value)

        <li class="nav-item"><a class="nav-link font-weight-medium" href="{{ $value->menu_link }}">{{ $value->menu_title }}</a></li>
